...
using NorthwindExample.Repository.Repositories;
using NorthwindExample.Repository.UnitOfWorks;
using NorthwindExample.Service.Mapping;
using NorthwindExample.Service.Services;
using System.Reflection;
using Module = Autofac.Module;

namespace NorthwindExample.API.Modules
{
